          ...
          <div class="mb-3">
            ...
            <c:forEach var="descuento" items="${descuentos}">
	            <div class="form-check">
	              <input class="form-check-input" type="radio" name="descuento" id="${descuento.valor}" value="${descuento.valor}" checked>
	              <label class="form-check-label" for="${descuento.valor}">
	                ${descuento.valor}%
	              </label>
	            </div>
            </c:forEach>
            ...
            <div class="">Tallas</div>
				<c:forEach var="talla" items="${tallas}">
		            <div class="form-check form-check-inline">
		              <input class="form-check-input" type="checkbox" name="talla" id="${talla.nombre}" value="${talla.nombre}">
		              <label class="form-check-label" for="${talla.nombre}">
		                ${talla.nombre}
		              </label>
		            </div>
		         </c:forEach>
