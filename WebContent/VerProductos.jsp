        ...
        <table class="table">
          ...
          <c:forEach var="producto" items="${productos}">
            <tr>
              ...
              <td>
                <a class="btn btn-danger" href="EliminarProducto?id=${producto.id}">
                ...
                <a class="btn btn-success" href="VerProducto?id=${producto.id}"><svg class="bi bi-eye" width="1em" height="1em" viewBox="0 0 16 16"
